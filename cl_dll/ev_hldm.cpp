...
void EV_FireMP5( event_args_t *args )
{
	...
	EV_HLDM_FireBullets(idx, forward, right, up, 1, vecSrc, vecAiming, 8192, BULLET_PLAYER_MP5, 2, &tracerCount[idx % HLARRAYSIZE(tracerCount) - 1], args->fparam1, args->fparam2);
}
