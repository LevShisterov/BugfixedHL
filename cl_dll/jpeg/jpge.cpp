...
bool compress_image_to_jpeg_file(const char *pFilename, int width, int height, int num_channels, const uint8 *pImage_data, bool flip_y, const params &comp_params)
{
...
bool compress_image_to_jpeg_file_in_memory(void *pDstBuf, int &buf_size, int width, int height, int num_channels, const uint8 *pImage_data, bool flip_y, const params &comp_params)
{
   if ((!pDstBuf) || (!buf_size))
      return false;
